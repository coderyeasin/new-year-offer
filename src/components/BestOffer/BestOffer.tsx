      ...
      <Section>
        ...
        <div className="h-165.5 w-full relative">
          <img
            src={gift}
            alt="gift"
            className="w-180 h-150 absolute -bottom-4 left-22 z-30"
          />
          <div className="bg-secondary leading-11 font-inter font-bold text-[28px] text-white flex flex-col justify-center items-center -rotate-30 h-48 w-48 rounded-full absolute right-18 top-48">
            <span className="text-[70px]">50%</span> DISCOUNT
          </div>
